...
function setInitialDelay() {
    setTimeout(function() {
        ...
        updateStatus('You are team <br> in <span style="color:#ff5c5c">Jaguar</span>');
    }, 1500);
}
    ...
    countdown = setInterval(function() {
        ...
        if (--timer < 0) {
            ...
            if (homeScore > awayScore)
                updateStatus('GAME OVER!<br>Mick Won!');
            else if (awayScore > homeScore)
                updateStatus('GAME OVER!<br>Jaguar Won!');
            else
...
function drawGoalPost() {
    ...
    if (goalDetection(box)) {
        updateScore('home');
        updateStatus('GOAL!<br>Jaguar Score!');
        removeStatus();
        resetBall();
        setDelay();
    }
    ...
    if (goalDetection(box)) {
        updateScore('away');
        updateStatus('GOAL!<br>Mick Score!');
        removeStatus();
        resetBall();
        setDelay();
    }
